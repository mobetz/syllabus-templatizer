...
public interface IScoreable {
	/*    ^
		...
		scoreable object should implement. Maybe we want any scoreable
		object to be able to give us the number of points it's worth
		and "activate" so that its points are enabled:
