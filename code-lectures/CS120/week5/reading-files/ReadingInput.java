...
public class ReadingInput {
	...
	public static void main(String[] args) throws FileNotFoundException {
      ...
      */ 
		...
		String file_name =  "resources/course_list.csv"; //<- file paths are represented as normal text!

		File course_list = new File( file_name );//<- this is a "relative path" to the File
      ...
      */
		...
		boolean does_this_file_exist = course_list.exists();
      ...
      Scanner course_reader = new Scanner( course_list ); // <- we give the file handle to the reader
        ...
        */
         ...
         // We just need to combine them with a loop!
       	 ...
       	 while (  course_reader.hasNext()  ) { //<- note, if there is a "header" to your file, you might have to nextLine() before your loop
            String next_line = course_reader.nextLine();
            System.out.println("\nThe next line of the file is: " + next_line.trim());
			...
			//has_more_text = course_reader.hasNext(); //<- if I use just the variable in my while condition, I need to change it here!
       	 }
