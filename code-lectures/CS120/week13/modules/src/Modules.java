...
public class Modules {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        If we care about limiting visibility (like maybe not every part of our program
        should be able to load things directly from file), then we need to use modules.

        Modules describe how packages are used outside that package: it lists what things
        should be available and what code should actually be readable.
