...
public class Review {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("This text is the single argument to the println() method.");

        /* When a method gives back a return value after it finishes, we can save that return value in a variable. */
         big_dec = Math.pow(2, 4);
        ...
        Once we have an object saved in a variable, we can tell that object to do something with the dot operator.
