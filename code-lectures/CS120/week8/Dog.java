...
public class Dog {
    ...
    Just like any other variable, attributes must be declared by giving Java a type and a name.
    ...
    */
    ...
    /* METHODS
    Each method describes a thing our class is able to do.
     ...
     */
     public boolean changeName(String newName) {
         ...
         */
     	...
     	if ( first_letter.equals(first_letter.toUpperCase())) {//Only allow dogs with capitalized names
