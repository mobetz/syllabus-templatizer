...
/**
  A MenuItem represents one thing that a Customer may want to purchase. MenuItems store all the information about 
  available customizations and price, and are created once for the Menu that they belong to. When an Order uses
  MenuItems, it will not change those items, just store additional details about the customizations separately.
  @author Prof. Obetz
  @version 1.0
  @Date 2023-03-01
*/
public class MenuItem {
	...
	/**
	  ...
	  Price should only ever have two decimal places. */
	...
	*/
	...
	/**
	 The allergy warnings. These should be options from the list "Dairy", "Gluten", "Vegan"
	*/
	...
	*/
    ...
    /**
      ...
      addGlutenWarning(), addVegan() methods described elsewhere in this calss.
     ...
     */
    public MenuItem(double price, String given_name, String given_description) {
    	this.price = price;
    	this.name = given_name;
    	this.description = given_description;

    	this.allergens = new String[3];
    	this.customizations = new String[5];
