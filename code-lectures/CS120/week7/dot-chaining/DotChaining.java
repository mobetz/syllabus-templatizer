...
By the end of today, you will be able to:
    ...
    * Describe how we can use the dot operator to chain together transformations to data.
...
public class DotChaining {
    public static void main(String[] args) {
        ...
        to use the dot operator, which always takes the form:
                     ...
                     some_object . something_I_want_to_do_on_that_object()
        ...
        File some_file = new File("hello.txt");
...
/*
        ...
        grades.recordLab(20);
        grades.recordLab(50);
        grades.getAssignment("Lab", 1).getPointsPossible();
*/
        ...
        String result = "    I wish I had a cute brown fox"
                          .trim()
                           .replace("cute", "quick")
                            .concat(" who could jump over lazy dogs.")
                             .toUpperCase();
        ...
        But if we look at this code, nothing different is happening here:
              ...
              But what if we wanted to make a class that works this way. Let's say, as an example, I wanted
              ...
              And I'm deciding I want each of these properties to be settable by a chained method, so that
              my final object can be used like this:
              */                         
