        ...
        We might decide that we've got a Grocery class that holds details about each item available for purchase,
          and a ShoppingList class that groups purchased items together and can provide a total cost.
                ...
                */
                ...
                System.out.print("Enter a grocery name: ");
                String entered_name = input.nextLine();

                System.out.print("Enter a grocery price: ");
                double entered_price = Double.parseDouble(input.nextLine());


                Grocery created_from_command_line = new Grocery(entered_name, entered_price);

                list.addItem(created_from_command_line);

                /*
                With our flexible class design, we can read from the terminal to construct groceries,
                but it works just as easily when we want read them from file:
                */

                Scanner grocery_reader = new Scanner(new File("resources/groceries.csv"));
                ...
                while ( grocery_reader.hasNext() ) {
                    ...
                    list.addItem(created_from_file);

                }

                System.out.println("The total cost for your shopping list is: " + list.getTotalCost());
